  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .header-mark{width:48px;height:48px;border-radius:12px;
                 ...
                 margin-bottom:16px;}
    .header-title{font-size:20px;font-weight:700;color:#ffffff;line-height:1.2;margin-bottom:6px;}
    .header-sub{font-size:13px;color:rgba(255,255,255,.5);}
    .body{padding:32px;}
    .greeting{font-size:15px;color:#0b1f4a;margin-bottom:16px;line-height:1.6;}
    .numero-box{background:#f4f7ff;border:1px solid rgba(26,58,143,.1);
    ...
    .numero-label{font-size:11px;font-weight:700;text-transform:uppercase;
                  letter-spacing:.1em;color:#7a8fb5;margin-bottom:6px;}
    .numero-val{font-family:'Courier New',monospace;font-size:22px;font-weight:700;
    ...
    .note{background:#f4f7ff;border-radius:8px;padding:14px 16px;
          font-size:12.5px;color:#7a8fb5;line-height:1.6;margin-top:20px;}
  ...
  <div class="card">
    ...
    <div class="body">
      ...
      <p style="font-size:14px;color:#3d5080;line-height:1.65;margin-bottom:0;">
        A sua inscrição foi recebida e encontra-se em análise pela comissão organizadora.
        Receberá uma notificação assim que for avaliada.
      </p>
      ...
      <div class="info-row">
        ...
        <span class="badge" style="background:#fffbeb;color:#b45309;border:1px solid #fde68a;">
          <span style="width:5px;height:5px;border-radius:50%;background:#b45309;"></span>
          Pendente
        </span>
      </div>

      <div class="note">
        Guarde este email. O número de inscrição será necessário para acompanhar
